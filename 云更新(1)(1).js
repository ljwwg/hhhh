...
ui.layout(
    ...
    <viewpager id="v">
    <vertical>
    <button id="b2" text="聊欢轰炸"/>
    <button id="b3" text="对对轰炸"/>
    <button id="b4" text="配配轰炸"/>
    <button id="b0" text="爱聊轰炸"/>
    <button id="b1" text="A号聊欢"/>
    <button id="b5" text="A号对对"/>
    <button id="b6" text="B号聊欢"/>
    <button id="b7" text="C号聊欢"/>
    <button id="b8" text="D号聊欢"/>
    </vertical>
    <vertical>
